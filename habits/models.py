...
class Habit(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, related_name='habits', verbose_name='Пользователь')
    ...
    days_of_week = models.CharField(max_length=13, blank=True, verbose_name='Дни недели (через запятую, 0=Пн,6=Вс)')
